...
#ifndef FREE_TIME_SWIFT_H
#define FREE_TIME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="free_time",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9free_time11AppDelegate")
...
SWIFT_CLASS("_TtC9free_time17MainFlutterWindow")
